        ...
        <div class="info">
          <div class="details-container">
            ...
            border-bottom:2px solid black;">
                  ...
                  <div class="span date"><h4>Apply Date</h4></div>
                  <div class="span comment"><h4>Document Comment</h4></div>
              </div>
            </div>
            ...
            <div class="details">
              ...
              <?php
                ...
                $count = 1;
                $sql = "select token_id, apply_date, document_comment from document_status where c_employee_id = '$id' and status = 'Rejected'";
                $result = mysqli_query($connection,$sql);
                
                while($row = mysqli_fetch_assoc($result)) {
                ?>
                <div class="row-details" style="height:100px;">
                    ...
                    <div class="span comment"><?php echo $row['document_comment'];?></div>
                </div>
                  <hr class="special-hr">
                <?php
                $count = $count + 1;
