        ...
        <div class="info">
          ...
          <div class="row-details" style="border-top:2px solid black;
            border-bottom:2px solid black;">
              ...
              <div class="span date"><h4>Date</h4></div>
              <div class="span status"><h4>Status</h4></div>
              <div class="span action-1"><h4>Action</h4></div>
            </div>
          </div>
              ...
              <?php
                ...
                $sql = "select token_id,c_employee_id,apply_date,status from document_status where to_employee_id IS NULL";
                ...
                <div class="row-details">
                  ...
                  <div class="span date"><?php echo $row['apply_date']; ?></div>
                  <div class="span status"><?php echo $row['status']; ?></div>
                  <div class="span action-1">
                  <span class="span"><a href="history.php?token_id=<?php echo $row['token_id'];?>"><button class="btna blue-btna">Details</button></a></span>
