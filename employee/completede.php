        ...
        <div class="info">
          <div class="details-container">
            ...
            border-bottom:2px solid black;">
                  ...
                  <div class="span date"><h4>Completed Date</h4></div>
              </div>
            </div>
              ...
              <?php
                ...
                $sql = "select token_id, apply_date, complete_date from document_status where c_employee_id = '$id' and status = 'Completed'";
                ...
                <div class="row-details">
                  ...
                  <div class="span date"><?php echo $row['complete_date'];?></div>
                </div>
                  <hr class="special-hr">
                <?php
                $count = $count + 1;
